/*
 *  Parblo Coast22 tablet monitor support
 *
 *  Copyright (c) 2020 David Sevy <david.sevy@gmail.com>
 *
 * Skrylar's Parblo Coast10 tablet driver was used as the
 * basis for this driver.
 * 
 *
 * 
 * 
...
#define NAME "ParbloCoast22\0"
#define NAME_LEN 15

/** \brief USB vendor ID of the device. */
#define USB_VENDOR_PARBLO_COAST22 0x0B57

/** \brief USB product ID of the device. */
#define USB_DEVICE_PARBLO_COAST22 0x9016
...
static const struct usb_device_id parblo_devices[] = {
  { USB_DEVICE(USB_VENDOR_PARBLO_COAST22, USB_DEVICE_PARBLO_COAST22) },
  {}
};
...
MODULE_AUTHOR("David Sevy <david.sevy@gmail.com>");
MODULE_LICENSE("GPL");
MODULE_VERSION("1");
